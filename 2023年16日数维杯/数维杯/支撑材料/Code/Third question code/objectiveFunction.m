%%%matlab
%%%The objective function of particle swarm algorithm
function cost = objectiveFunction(n)
    % Parameter definition
    m = [0.25, 0.09, 0.11, 0.19, 0.08, 0.1, 0.12, 0.11, 0.18, 0.22]; % Detergent unit price array
    m=m*10;
    A = 1;   % Detergent dosage factor
    D_j = [116, 91, 96, 106, 99, 71, 86, 76]; % Initial dirt amount array
    a_ij = [0.54, 0.75, 0.78, 0.69, 0.8, 0.66, 0.55, 0.73;
            ...
            0.47, 0.81, 0.77, 0.53, 0.64, 0.59, 0.53, 0.42]; % Solubility matrix of soil in detergents
    ...
    large_penalty = 10000; % or other sufficiently large values
